...
public class SerialInputOutputManager implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            objCls_logger.new SendPostRequest().execute("Run ending due to exception: " + e.getMessage());
            ...
            synchronized (this) {
                ...
                objCls_logger.new SendPostRequest().execute("SerialIOManager Stopped");
                Log.i(TAG, "Stopped.");
            }
        }
    }
...
//            if (DEBUG) Log.d(TAG, "Read data len=" + len);
            ...
            if (listener != null) {
                ...
                //Log.d(TAG, "Tv response=" + HexDump.dumpHexString(data));
            }
            //Log.d(TAG, "step: bufferCleared");
            mReadBuffer.clear();
        }
        ...
        if (outBuff != null) {
            ...
            String varcodesent = HexDump.toHexString(outBuff);
...
//            Log.d(TAG, "step: clearing readBuffer");
            len=0;
            mReadBuffer.clear();
        }else{
            len = mDriver.read(mReadBuffer.array(), READ_WAIT_MILLIS);
